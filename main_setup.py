...
def main():
    ...
    unzip_button = create_button("Unzip", unzip)
    ...
    unzip_button.pack(pady=(20, 10))

    # Pack the other buttons with padding and some space on the sides
    for button in [store_info_button,mysql_string_button, config_file_button, online_order_button]:
